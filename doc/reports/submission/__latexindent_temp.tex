...
Figures \ref{}, \ref{}, and \ref{} show estimatation for hedge portfolio alpha per month, for each standard factor pricing model, using a specific loss minimisation strategy.
