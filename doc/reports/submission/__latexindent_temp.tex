...
\usepackage{float}
%%% FLOW DIAGRAM STYLE
\definecolor{inputlayercolour}{RGB}{39,97,243}
...
\end{itemize}
The architecture for analysis is a large MLP.
\subsubsection{Model Configuration}
Figure \ref{fig:neural-network} visualises the topography of a standard neural network.
\begin{figure}[H]
    \centering
...
The architecture of the network is derivative of the model's intended use.
The set of
\newpage
Figure \ref{fig:neural-network-configuration} illustrates the configuration for this project (work in prgoress).
\begin{figure}[H]
	\centering
	\begin{tikzpicture}[node distance=2cm]
	\node (in) [inputs] {\textbf{$N_{(0,a)}$: Input} \\ (Features: 189)};
	\node (hidden1) [hiddenlayer, below of=in, yshift=-1cm] {\textbf{Dense I} \\ \text{$N_{(1,b)}$}:  \\ \text{$h_{w}(\textbf{x})$} = RELU(z) (\ref{relu-activation-function})};
	\node (hidden2) [hiddenlayer, below of=hidden1, yshift=-1.5cm] {\textbf{$N_{(2,c)}$: Dropout I} \\ Nodes: 32 \\ Dropout Rate = 50\%};
	\node (hidden3) [hiddenlayer, below of=hidden2, yshift=-1.5cm] {\textbf{$N_{(3,d)}$: Dense II} \\ Nodes: 64 \\ \text{$h_{w}(\textbf{x})$} = RELU(z) (\ref{relu-activation-function})};
	\node (hidden4) [hiddenlayer, below of=hidden3, yshift=-1.5cm] {\textbf{$N_{(4,e)}$: Dense III} \\ Nodes: 128 \\ \text{$h_{w}(\textbf{x})$} = RELU(z) (\ref{relu-activation-function})};
	\node (output) [outputlayer, below of=hidden4, yshift=-1.5cm] {\textbf{$N_{(5,f)}$: Dense IV} \\ Nodes: 1 \\ \text{$h_{w}(\textbf{x})$} = Linear(z) (\ref{linear-activation-function})};
	\node (predict) [predict, below of=output, yshift=-1cm] {\textbf{Prediction}};
	\draw [arrow] (in) -- node[anchor=west] {\text{$\sum_{a = 1}^{189} w_{(0,a,b)}x_{(i)}$}} (hidden1);
	\draw [arrow] (hidden1) -- node[anchor=west] {\text{$\sum_{b = 1}^{189}w_{(1,i)}y_{(i)}$}} (hidden2);
	\draw [arrow] (hidden2) -- node[anchor=west] {\text{$\sum_{c = 1}^{189}w_{(2,i)}x_{(i)}$}} (hidden3);
	\draw [arrow] (hidden3) -- node[anchor=west] {\text{$\sum_{d = 1}^{189}w_{(3,i)}x_{(i)}$}} (hidden4);
	\draw [arrow] (hidden4) -- node[anchor=west] {\text{$\sum_{e = 1}^{189}w_{(4,i)}x_{(i)}$}} (output);
...
\end{figure}
\newpage
\textbf{10 epochs, 207 runs per epochs.}
\section{Brief Description of Remaining Methods}
\begin{itemize}
...
\begin{figure}[H]
    ...
    \caption{Mean Square Error Model (Tensorflow)}
...
\begin{figure}[H]
    ...
    \caption{Sharpe Ratio Loss Function}
    \label{fig:sr-performance}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{sharpe-mse.png}
    \caption{Sharpe Ratio (MSE) Loss Function}
    \label{fig:sr-mse-performance}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{information.png}
    \caption{Information Ratio Loss Function}
    \label{fig:ir-performance}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{hedge-portfolio.png}
    \caption{Hedge Portfolio Loss Function}
    \label{fig:hp-performance}
\end{figure}
\newpage
\begin{landscape}
\subsection{Hedge Portfolio Performance}
\subsubsection{Realised Excess Returns}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-realised-excess-returns}.tex}
\newpage
\subsubsection{Mean Square Error (Tensorflow)}
...
\newpage
\subsubsection{Sharpe Ratio}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_sharpe}.tex}
\newpage
\subsubsection{Sharpe Ratio (MSE)}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_sharpe\_mse}.tex}
\newpage
\subsubsection{Information Ratio}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_information}.tex}
\newpage
\end{landscape}
Fama MacBeth Regressions using individual securities.
PooledOLS replaces Fama MacBeth in this instance.
\subsection{Individual Panel Regressions}
\subsubsection{Realised Excess Returns}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-realised-excess-returns-capm}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-realised-excess-returns-ff3}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-realised-excess-returns-ff4}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-realised-excess-returns-ff5}.tex}
\newpage
\subsubsection{Mean Square Error (Tensorflow)}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-mean\_squared\_error-capm}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-mean\_squared\_error-ff3}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-mean\_squared\_error-ff4}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-mean\_squared\_error-ff5}.tex}
\newpage
\subsubsection{Mean Square Error}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_mse-capm}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_mse-ff3}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_mse-ff4}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_mse-ff5}.tex}
\newpage
\subsubsection{Hedge Portfolio}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_hp-capm}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_hp-ff3}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_hp-ff4}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_hp-ff5}.tex}
\newpage
\subsubsection{Sharpe Ratio}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_sharpe-capm}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_sharpe-ff3}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_sharpe-ff4}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_sharpe-ff5}.tex}
\newpage
\subsubsection{Sharpe Ratio (MSE)}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_sharpe\_mse-capm}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_sharpe\_mse-ff3}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_sharpe\_mse-ff4}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_sharpe\_mse-ff5}.tex}
\newpage
\subsubsection{Information Ratio}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_information-capm}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_information-ff3}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_information-ff4}.tex}
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-custom\_information-ff5}.tex}
\section{Discussion}
