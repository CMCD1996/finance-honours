...
The negative co-efficient is not unexpected given the objective function seeks to maximise redicted hedge portfolio returns opposed minimising the loss between actual and realised.
...
Figure \ref{performance-metrics} displays the mean
...
The predicting of construction of hedge protfolios should reflect this construction methodology.
However, equities below the 20th percentile were omitted, as mentioned in section \ref{data}. 
...
The market risk premia is statistical insignificant in CAPM, FF4, and FF5 for the netword maximising hedge portfolio returns.
The market risk premia factor is negative in all models accross loss functions. The out-of-sample period includes both the Dotcom crash and Financial Crisis.
...
This is a partial, novel contribution tp the literature.
