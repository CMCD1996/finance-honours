...
\begin{figure}[H]
    ...
    \subfloat[In-Built Mean Square Error Learning curve\label{fig-lc-mse}]{%
      \includegraphics[width=\textwidth]{mean-squared-error-learning-curve.png}
    }
    \vfill
    \subfloat[Custom MSE\label{fig-lc-cmse}]{%
      \includegraphics[width=\textwidth]{custom-mse-learning-curve.png}
    }
  ...
  \begin{figure}[H]
	\centering
    \includegraphics[width=\textwidth]{custom-hp-learning-curve.png}
...
\input{{/Users/connor/Google Drive/Documents/University/Courses/2020-21/Finance 788/finance-honours/results/tex/cmcd398-finance-honours-regression-metrics-hedge}.tex}
