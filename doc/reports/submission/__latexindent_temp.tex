...
\section{Methodology}
This research implements the subsequent methodology.
\begin{itemize}
	\item 
\end{itemize}
\subsection{Target Variable}
The selected target variable is one month lead excess returns ('ret\_exc\_lead1m') from the factor replication dataset
