...
\begin{figure}[H]
	...
	\draw [arrow] (in) -- node[anchor=west] {\text{$w_{i}x_{i}$}} (hidden1);
	\draw [arrow] (hidden1) -- node[anchor=west] {\text{$w_{i}x_{i}$}} (hidden2);
	\draw [arrow] (hidden2) -- node[anchor=west] {\text{$w_{i}x_{i}$}} (hidden3);
	\draw [arrow] (hidden3) -- node[anchor=west] {\text{$w_{i}x_{i}$}} (hidden4);
	\draw [arrow] (hidden4) -- node[anchor=west] {\text{$w_{i}x_{i}$}} (output);
