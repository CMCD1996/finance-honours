...
\subsubsection{Hedge Portfolio Returns}
...
\subsection{Hedge Portfolios}
Hedge portfolios rely on monotonic functions for optimisation purposes.
These functions both preserve or reverse a given ordered set.
We rank the cross-section of one-month lead portfolio excess returns using monotonic functions depending on
\begin{align}
	R(y_{i,t})
\end{align}
